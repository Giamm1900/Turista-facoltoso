        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Totale: {filteredReservations.length}
              </CardDescription>
            </div>
                ...
                {currentItems.length > 0 ? (
                  currentItems.map((res) => (
                    <TableRow key={res.id}>
                      ...
                      <TableCell>
                        <BadgeLabel color="blue">
                          Utente ID: {res.utenteId}
                        </BadgeLabel>
                      </TableCell>
                      <TableCell>
                        <BadgeLabel color="purple">
                          Abitazione ID: {res.abitazioneId}
                        </BadgeLabel>
                      </TableCell>
                      <TableCell className="text-sm">
                        <div className="flex flex-col">
                          <span>
                            In: {new Date(res.dataInizio).toLocaleDateString()}
                          </span>
                          <span className="text-muted-foreground text-xs">
                            Out: {new Date(res.dataFine).toLocaleDateString()}
                          </span>
                        </div>
                      </TableCell>
